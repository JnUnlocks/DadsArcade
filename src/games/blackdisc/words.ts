...
export const CATEGORIES: readonly DiscCategory[] = [
  ...
  },
  {
    ...
    words: [
      ...
      "The Lord's Prayer", "Abraham and Sarah", "Isaac and Rebekah", "Jacob and Esau", "Joseph's Coat of Many Colors",
      "Joseph Sold into Slavery", "Joseph Interpreting Dreams", "Jacob Wrestling the Angel", "The Exodus from Egypt", "Crossing the Jordan River",
      "The Twelve Tribes of Israel", "Gideon's Fleece", "Samson and the Lion", "Ruth Gleaning in the Fields", "Hannah's Prayer",
      "David Playing the Harp", "David and Bathsheba", "Solomon Building the Temple", "The Queen of Sheba", "Elijah and the Prophets of Baal",
      "Elijah Fed by Ravens", "The Widow's Jar of Oil", "Naaman's Healing", "Esther Saving Her People", "The Writing on the Wall",
      "Shadrach, Meshach, and Abednego", "Rebuilding the Temple Walls", "The Annunciation", "The Flight into Egypt", "Jesus in the Temple as a Boy",
      "The Calling of the Disciples", "The Transfiguration", "The Woman at the Well", "Healing the Blind Man", "The Raising of Lazarus",
      "The Triumphal Entry", "Washing the Disciples' Feet", "The Garden of Gethsemane", "Judas's Betrayal", "The Road to Emmaus",
      "Pentecost", "Paul's Conversion", "Paul's Shipwreck", "The Armor of God", "Mount Sinai",
      "The Tabernacle", "Manna from Heaven", "The Golden Calf", "The Sea of Galilee", "Jacob's Well",
      "The Upper Room", "The Fruit of the Spirit", "The Beatitudes",
    ],
  },
  {
    id: "holidays",
    ...
    words: [
      ...
      "Holiday lights", "Hanukkah candles", "Kwanzaa", "Chinese New Year", "Dragon dance parade",
      "Christmas Eve", "Boxing Day", "Mistletoe", "Gingerbread house", "Baking Christmas cookies",
      "Stocking stuffers", "Reindeer", "Caroling door to door", "Nativity scene", "Snowball fight",
      "Building a snowman", "Sledding", "Ice skating", "Hot cocoa by the fire", "New Year's kiss",
      "Ball drop in Times Square", "Easter basket", "Dyeing Easter eggs", "Spring cleaning", "May Day",
      "Cinco de Mayo fiesta", "Flag Day", "Independence Day parade", "Backyard barbecue", "Watermelon eating contest",
      "Back to school", "Harvest festival", "Corn maze", "Hayride", "Apple picking",
      "Trunk-or-treat", "Haunted house", "Halloween parade", "Bobbing for apples", "Candy corn",
      "Thanksgiving parade", "Black Friday shopping", "Carving the turkey", "Setting the table", "Retirement party",
      "Housewarming party", "Quinceañera", "Bar mitzvah", "Bridal shower", "Bachelor party",
      "Prom night", "Homecoming", "Class reunion",
    ],
  },
];
